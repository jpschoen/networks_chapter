...
\hline
 & Model 1 & Model 2 & Model 3 \\
\hline
edges                      & $-3.10^{*}$       & $-3.00^{*}$       & $-3.12^{*}$       \\
                           & $[-3.28;\ -2.91]$ & $[-3.55;\ -2.41]$ & $[-4.35;\ -1.92]$ \\
absdiff.age                & $-0.03^{*}$       & $-0.04^{*}$       & $-0.08^{*}$       \\
                           & $[-0.04;\ -0.01]$ & $[-0.06;\ -0.02]$ & $[-0.13;\ -0.03]$ \\
nodematch.education        & $0.22^{*}$        & $0.35^{*}$        & $0.93^{*}$        \\
                           & $[0.15;\ 0.27]$   & $[0.20;\ 0.53]$   & $[0.11;\ 1.81]$   \\
nodematch.floor            & $1.02^{*}$        & $1.53^{*}$        & $1.16^{*}$        \\
                           & $[0.70;\ 1.28]$   & $[1.51;\ 1.55]$   & $[0.25;\ 2.17]$   \\
nodematch.leadership.FALSE & $-0.82^{*}$       & $-0.28^{*}$       & $-0.82^{*}$       \\
                           & $[-0.92;\ -0.71]$ & $[-0.45;\ -0.01]$ & $[-1.68;\ -0.04]$ \\
nodematch.leadership.TRUE  & $0.61^{*}$        & $0.44$            & $0.64$            \\
                           & $[0.60;\ 0.62]$   & $[-0.10;\ 1.06]$  & $[-0.39;\ 1.61]$  \\
nodematch.UF               & $2.75^{*}$        & $2.56^{*}$        & $1.31^{*}$        \\
                           & $[2.61;\ 3.02]$   & $[2.23;\ 2.92]$   & $[0.08;\ 2.71]$   \\
nodematch.party            & $2.86^{*}$        & $2.30^{*}$        & $3.47^{*}$        \\
                           & $[2.65;\ 3.09]$   & $[2.24;\ 2.37]$   & $[2.73;\ 4.32]$   \\
\hline
